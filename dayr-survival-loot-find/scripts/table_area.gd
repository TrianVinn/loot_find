...
var items_table = [
	{name = "apple", chance_drop = 100, min_amount = 1.0, max_amount = 5.0,amount = 0, texture = "res://apple.png"},
	{name = "wood", chance_drop = 100, min_amount = 4.0, max_amount = 20.0,amount = 0, texture = "res://wood.png"}
	]
var dropped_items = []
var is_looted = false
var slots 
...
func cikl_():
	...
	for dropped_item in dropped_items.size():
		item = dropped_items[dropped_item]
				...
				### Получаем доступ к контейнерамzone_loot.GridContainer ###
